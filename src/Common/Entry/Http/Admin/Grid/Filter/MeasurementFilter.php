...
use App\Common\Entry\Http\Admin\Form\Filter\MeasurementType;
use Exception;
...
#[AutoconfigureTag(
    ...
    attributes: [
        'type' => 'measurement',
        'form_type' => MeasurementType::class,
    ]
)]
class MeasurementFilter implements FilterInterface
{
    /**
     * @throws Exception
     */
    ...
    {
        $value = trim($data[$name] ?? $data['value'] ?? '');
        if ('' === $value) {
            return;
        }
