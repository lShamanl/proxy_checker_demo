...
use App\ProxyChecker\Application\CheckList\UseCase\Edit\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_proxy_checker_edit';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Update command for CheckList",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/proxy-checker/check-lists/edit.{_format}',
        name: self::NAME,
