...
use App\ProxyChecker\Application\CheckList\UseCase\Create\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_proxy_checker_create';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Create command for CheckList",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/proxy-checker/check-lists/create.{_format}',
        name: self::NAME,
