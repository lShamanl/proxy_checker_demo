...
class Action
{
     ...
     * @OA\Response(
     *     response=200,
     *     description="Search query for CheckList",
     *     @OA\JsonContent(
     *          allOf={
     ...
     */
    #[Route(
        path: '/api/admin/proxy-checker/check-lists.{_format}',
        name: self::NAME,
    ...
    public function action(
        ...
        return $presenter->present(
            data: ApiFormatter::prepare([
                'data' => array_map(static function (CheckList $checkList) {
                    return CommonOutputContract::create($checkList);
